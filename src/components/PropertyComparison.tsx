...
const PropertyComparison: React.FC = () => {
  ...
  const features = [
    ...
    { 
      ...
      whiteSands: false, 
      russellHeights: true,
      description: "Russell Heights Property offers dedicated event spaces for celebrations, meetings, and special occasions."
    },
    { 
      name: "Fitness Center", 
      whiteSands: false, 
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  ...
                  <th className="p-6 text-center bg-blue-100 border-b-2 border-blue-300 rounded-tr-xl">
                  ...
                  <React.Fragment key={index}>
                    ...
                    {expandedFeature === index && (
                      <tr className="bg-blue-50">
                        <td colSpan={3} className="p-4 text-sm text-gray-700 border-b border-gray-200">
